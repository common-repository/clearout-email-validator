		...
		*/
		...
		setTagEvents : function() {
			...
			$(this.selectors.sTagsInput).blur(function(){
				...
				// Edit: To Support Adding while blur, instead of only Pressing enter or delimeter -Nish
		...
		addTag : function(value, animate=true) {
			...
			var html = '<span class="'+this.classes.tagItem.substring(1)+'" data-val="'+value+'">'+'<a href="'+ this.getTag(value) + '" target="_blank">'+this.getTag(value)+'</a>' + ' '+this.setIcon()+'</span>';
